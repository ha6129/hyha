function BtnNew() {
    ...
    location.href = "/Purchase/PurchaseRegist";
}
...
//날짜 당일셋팅
if (location.pathname == "/Purchase/PurchaseRegist") {
...
function BtnList() {
    ...
    if (location.pathname == "/Purchase/PurchaseList") {
...
function BtnEdit() {
    ...
    location.href = "/Purchase/PurchaseRegist?Customer=" + cust + "&Product=" + prod + "&quantity=" + quantity + "&date=" + date + "&index=" + index;
}
...
function BtnDelete() {
    ...
    for (var i = 0; i < checkedRows.length; i++) {
        ...
        purchase.push({ index: index, Product: { Code: prodcode, Name: prodname }, quantity: quantity, datatime: date, Customer: { Code: custcode } });
    }
